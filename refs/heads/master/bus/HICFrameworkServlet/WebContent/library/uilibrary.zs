...
public boolean showListData(IHICData hicData, Object elementObj)
{
		...
		if(listValues==null)
		{
			...
			if(allValues==null)
			{
				...
				{
					elementObj.setRowRenderer(new RowRendererArray());
				}	
				return false;
			}
			else
			{
				System.out.println("Inside showdatalist 2"+elementObj);
		...
		{
			//System.out.println("Inside showdatalist else");
	...
	button.addEventListener("onClick", new EventListener()
		        {
				    public void onEvent(Event event1) 
				    {
				    	...
				    	{
				    		System.out.println("Add Event Listener  warning onClick in addNewComponent function");
				    	}
				    }
        });
	...
	cbox.addEventListener("onSelect", new EventListener()
		        {
				    public void onEvent(Event event1) 
				    {
				    	...
				    	{
				    		System.out.println("Add Event Listener warning OnSelect in addNewComponent function");
				    	}
	...
	cbox.addEventListener("onSelect", new EventListener()
		        {
				    public void onEvent(Event event1) throws Exception 
				    {
				    	...
				    	{
				    		System.out.println("Add CheckBox Event Listener warning OnSelect in addNewComponent function");
				    	}
				    }
        });
	...
	checkbox.addEventListener("onCheck", new EventListener()
		        {
				    public void onEvent(Event event1) 
				    {
				    	...
				    	{
				    		System.out.println("Add CheckBox Event Listener warning OnCheck in addNewComponent function");
				    	}
	...
	txtbox.addEventListener("onChange", new EventListener()
		        {
				    public void onEvent(Event event1) 
				    {
				    	...
				    	{
				    		System.out.println("Add Textbox Event Listener warning OnChange in addNewComponent function");
				    	}
				    }
        });
	...
	button.addEventListener("onClick", new EventListener()
		        {
				    public void onEvent(Event event1) 
				    {
						...
						{
							System.out.println("Add Button Event Listener warning OnClick in addQueryComponent function");
						}
				    }
        });
	...
	cbox.addEventListener("onSelect", new EventListener()
		        {
				    public void onEvent(Event event1)  
				    {
						...
						{
							System.out.println("Add Chcekcbox Event Listener warning onSelect in addQueryComponent function");
						}
				    }
        });
	//Category Combobox
	...
	checkbox.addEventListener("onCheck", new EventListener()
		        {
				    public void onEvent(Event event1)  
				    {
						...
						{
							System.out.println("Add Checkcbox Event Listener warning onCheck in addQueryComponent function");
						}				    	
				    }
        });
	...
	txtbox.addEventListener("onChange", new EventListener()
		        {
				    public void onEvent(Event event1) throws Exception 
				    {
						...
						{
							System.out.println("Add Textbox Event Listener warning onChange in addQueryComponent function");
						}	
				    }
        });
//Rangeone textbox	
		...
		public void onEvent(Event event)
	 	{
			...
			{
				System.out.println("Add Event Listener warning on OnDrop in addVisitList function");
			}
		...
		{  	
			...
			list.addEventListener("onDrop", new EventListener()
			{
				public void onEvent(Event event)
				{
					...
					{
						System.out.println("Add Event Listener warning on OnDrop in createRooms function");
					}
			...
			public void onEvent(Event event)
			{
				try
					...
					{
						System.out.println("Add Event Listener warning on OnSelect in createRooms function");
					}
		...
		{  	
			...
			list.addEventListener("onDrop", new EventListener()
			{
				public void onEvent(Event event)
				{
					...
					{
						System.out.println("Add Event Listener warning on OnDrop in createRoomAssignment function");
					}
				}
			});	
			list.addEventListener("onSelect", new EventListener()
