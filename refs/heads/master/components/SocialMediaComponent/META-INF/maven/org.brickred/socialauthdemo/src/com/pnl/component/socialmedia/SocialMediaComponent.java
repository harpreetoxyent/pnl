...
public class SocialMediaComponent implements ISocialMediaComponent , IComponent{
	...
	{		
		...
		String providerId = (String) data.getFormPattern().getFormValues().get("providerId");
		
		String callbackURL = "http://";
		// get Provider URL to which you should redirect for authentication.
		  // id can have values "facebook", "twitter", "yahoo" etc. or the OpenID URL
		String url = socialAuthManager.getAuthenticationUrl(providerId, successUrl);
		AuthProvider provider = socialAuthManager.connect(new HashMap<String, String>());
		// get profile
