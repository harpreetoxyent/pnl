...
public class HomeController
{
	...
	public ModelAndView showRegistration(final HttpServletRequest request) {
		...
		session.setAttribute(ActionConstants.REQUEST_TYPE, ActionConstants.REGISTRATION);
	...
	public ModelAndView showRegistrationPage(
			@ModelAttribute("user") final UserInfo user,
	...
	public ModelAndView importContacts(final HttpServletRequest request) {
		...
		HttpSession session = request.getSession();
		session.setAttribute(ActionConstants.REQUEST_TYPE, ActionConstants.IMPORT_CONTACTS);
	...
	public ModelAndView shareForm(final HttpServletRequest request) {
		...
		HttpSession session = request.getSession();
		session.setAttribute(ActionConstants.REQUEST_TYPE, ActionConstants.SHARE);
